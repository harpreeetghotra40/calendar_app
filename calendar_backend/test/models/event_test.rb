...
class EventTest < ActiveSupport::TestCase
  ...
  test 'cannot create partial event' do
    ...
    assert_raise do
      Event.create!(title: 'Fart', description: 'fart', calendar: Calendar.first)
    end
  ...
  test 'can create reasonable event' do
    assert_nothing_raised do
      new_event = Event.create!(title: 'hello days', event_time: '2019-08-16T20:32:19.375Z', calendar: Calendar.first)
